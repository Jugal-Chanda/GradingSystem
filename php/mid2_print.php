...
$sql = "SELECT weight,exam_taken from co where co_id=4;";
...
<table style="width: 90%;margin-left: 5%;margin-right: 5%;">
    <caption style="text-align: center;margin-bottom: 20px;">
        <b>Mid Term 2 Exam Spring 2019</b><br>
...
$sql = "SELECT total,student_list.student_id,student_list.student_name FROM mid2,student_list where student_list.student_id=mid2.student_id and mid2.sec_id = '$sec_id';";
$result = $conn->query($sql);
