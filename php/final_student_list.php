...
<table style="margin-top: 20px;">
		...
		$sql = "SELECT student_list.student_id as uni_std_id,student_name,co1,co2,co3,co4,total FROM student_list,final WHERE final.student_id = student_list.student_id AND  final.sec_id= '$sec_id';";
