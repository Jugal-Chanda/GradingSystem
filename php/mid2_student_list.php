...
<table style="margin-top: 20px;">
		...
		$sql = "SELECT student_list.student_id as uni_std_id,student_name,co1,co2,co3,co4,total FROM student_list,mid2 WHERE mid2.student_id = student_list.student_id AND  mid2.sec_id= '$sec_id';";
